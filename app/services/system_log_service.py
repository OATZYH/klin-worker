...
from app.services.observability import get_current_request_id, get_current_trace_id
...
class SystemLogService:
    ...
    async def log(
        ...
        *,
        ...
        resolved_correlation_id = correlation_id or get_current_trace_id() or get_current_request_id()
